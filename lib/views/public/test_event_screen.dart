...
import 'test_reservation_screen.dart'; // Import ajouté

class TestEventScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Test Événements')),
      body: Padding(
        padding: const EdgeInsets.all(16.0),
        child: Column(
          children: [
            if (auth.user == null)
              Text('Connectez-vous pour créer un événement')
            else ...[
              // Formulaire
